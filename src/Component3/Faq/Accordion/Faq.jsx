      ...
      <section className="relative overflow-hidden bg-[#e6eefb] rounded-xl p-2 sm:p-5 md:p-10">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 items-center">
            ...
            <form action="#" method="post" className="flex flex-col gap-y-5">
              <div className="relative inline-block">
                <input
                  ...
                  required
                  className="font-Nunito text-white placeholder:text-white font-light bg-[#3a7ae4] border-none rounded py-2 px-6 h-[50px] w-full focus:outline-PrimaryColor-0"
                />
                <FaUser
                  size={"14"}
              ...
              <textarea
                ...
                className="font-Nunito text-white placeholder:text-white font-light bg-[#3a7ae4] border-none rounded py-2 px-6 h-[120px] w-full focus:outline-PrimaryColor-0 resize-none"
              ></textarea>
                <button type="submit" className="primary-btn3 !justify-center !py-3">
                  Free Consultancy
                </button>
            </form>
          </div>
          <div className="relative w-full mx-auto">
            ...
            <h1 className="font-Rajdhani font-bold text-xl leading-7 sm:text-[34px] sm:leading-[44px] md:text-[44px] md:leading-[54px] lg:text-[30px] lg:leading-[40px] xl:text-[44px] xl:leading-[46px] 2xl:text-[48px] 2xl:leading-[50px] text-HeadingColor-0 mt-3 mb-12">
