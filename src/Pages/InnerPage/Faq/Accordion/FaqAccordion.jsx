  ...
  return (
    <div className="mb-5 rounded-md overflow-hidden">
      ...
      <div
        ...
        className={`grid font-Nunito font-light leading-[26px] text-TextColor2-0 bg-white px-4 md:px-7 lg:px-6 xl:px-7 overflow-hidden transition-all duration-300 ease-in-out bg-normalBlack ${
          accordionOpen
