...
const ContactBoxCard = ({
  ...
  return (
    <div className="group px-5 sm:px-[30px] md:px-5 xl:px-[30px] py-6 rounded-md flex items-center gap-2 sm:gap-5 lg:gap-2 2xl:gap-5 border border-PrimaryColor-0 bg-white relative z-10 before:absolute before:top-0 before:right-0 before:-z-10 before:w-0 before:h-full before:bg-PrimaryColor-0 before:transition-all before:duration-500 hover:before:w-full hover:before:left-0 h-[200px]"> {/* Increased height */}
      ...
      <div className="flex-1 flex flex-col justify-center"> {/* Use flex to center content */}
