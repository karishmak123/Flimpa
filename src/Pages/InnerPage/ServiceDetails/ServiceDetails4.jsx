        ...
        <div className="Container">
          <div className="grid grid-cols-3 gap-[50px]">
            <div className="col-span-3 lg:col-span-2">
              ...
              WebSpread offers proficient, decent as well as stable Mobile Application Development services which are furnished to various client requirements and business aspirations. Customized Mobile Apps are designed and developed to meet client demands.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-7">
                <div className="flex flex-col md:flex-row lg:flex-col xl:flex-row gap-5 bg-[#f3f4f8] rounded-md px-6 py-7">
                  ...
                  <div className="flex-1">
                    ...
                    WebSpread offers proficient, decent as well as stable Android Application Development services which are furnished
                    </p>
                  </div>
                </div>
                <div className="flex flex-col md:flex-row lg:flex-col xl:flex-row gap-5 bg-[#f3f4f8] rounded-md px-6 py-7">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-Nunito text-TextColor2-0 mt-3">
                    iPhone has completely metamorphosed the world of Mobile phones. It has set an altar to create almost all kinds
                    </p>
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-7 mt-5">
                <div className="flex flex-col md:flex-row lg:flex-col xl:flex-row gap-5 bg-[#f3f4f8] rounded-md px-6 py-7">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-Nunito text-TextColor2-0 mt-3">
                    Mobile User Interface (UI) is one of the vital key here in attracting users to your business. It helps in marketing
                    </p>
                  </div>
                </div>
                <div className="flex flex-col md:flex-row lg:flex-col xl:flex-row gap-5 bg-[#f3f4f8] rounded-md px-6 py-7">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-Nunito text-TextColor2-0 mt-3">
                    We are provideing Mobile App Maintenace completely metamorphosed the world of Mobile phones. It has set an altar to create..
                    </p>
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-1 gap-7 mt-5">
                <div className="flex flex-col md:flex-row lg:flex-col xl:flex-row gap-5 bg-[#f3f4f8] rounded-md px-6 py-7">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-Nunito text-TextColor2-0 mt-3">
                    Hybrid App has completely metamorphosed the world of Mobile phones. It has set an altar to create almost all kinds                    </p>
                  </div>
                </div>
