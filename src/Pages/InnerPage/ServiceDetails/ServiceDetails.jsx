              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-7">
                <div className="flex flex-col md:flex-row lg:flex-col xl:flex-row gap-5 bg-[#f3f4f8] rounded-md px-6 py-7">
                  ...
                  <div className="flex-1">
                    ...
                    WebSpread web designer is one of the leading web designing company in USA, INDIA specialized in Responsive
                    </p>
                  </div>
                </div>
                <div className="flex flex-col md:flex-row lg:flex-col xl:flex-row gap-5 bg-[#f3f4f8] rounded-md px-6 py-7">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-Nunito text-TextColor2-0 mt-3">
                    Looking for PSD to HTML conversion company - contact WebSpread to have a PSD design converted into HTML perfectly
                    </p>
                  </div>
                </div>
              </div>
