          ...
          <div className="col-span-2">
            ...
            <form action="#" method="post" className="flex flex-col gap-y-7">
              ...
              <textarea
                ...
                className="font-Nunito text-TextColor2-0 font-light bg-transparent border-2 border-BorderColor2-0 rounded py-2 px-6 h-[160px] w-full focus:outline-PrimaryColor-0 resize-none"
              ></textarea>
