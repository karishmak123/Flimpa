        ...
        <div className="grid grid-cols-1 gap-10 lg:gap-16 xl:gap-24 2xl:gap-[110px] lg:grid-cols-2 items-center">
          ...
          <div className="grid gap-7 grid-cols-1 sm:grid-cols-2 items-center">
            <div className="choose-box group text-center bg-white rounded-md px-[30px] lg:px-4 xl:px-[30px] pt-9 pb-10 relative z-10  before:absolute before:top-0 before:right-0 before:-z-10 before:w-0 before:h-full before:bg-SecondaryColor-0 before:rounded-md before:transition-all before:duration-500">
              ...
              <h6 className="choose-title text-[26px] rounded font-Rajdhani text-HeadingColor-0 font-semibold transition-all duration-500 mt-4 mb-1">
                Business Plan
              </h6>
              ...
              <div className="flex items-end justify-center gap-1 border-b border-BorderColor2-0 pb-5">
                <div className="flex gap-1">
                  <h6 className="choose-price transition-all duration-500 font-Rajdhani font-semibold text-2xl text-HeadingColor-0">
                    $
                  </h6>
                  <CountUp
                    start={-9}
                    ...
                    prefix=""
                    suffix=""
                    className="choose-price text-[50px] leading-[50px] font-Rajdhani font-semibold text-HeadingColor-0 transition-all duration-500"
                  />
                </div>
                <h6 className="choose-price font-Rajdhani text-TextColor2-0 text-lg transition-all duration-500">
                  / Month
                </h6>
              </div>
              <ul className="flex flex-col gap-3 mt-6 mb-9">
                <li className="choose-list font-Nunito text-TextColor2-0 transition-all duration-500">
                  10+ user Account
                </li>
                <li className="choose-list font-Nunito text-TextColor2-0 transition-all duration-500">
                  Moneyback Gaurentee
