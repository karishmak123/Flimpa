...
const Process = () => {
  return (
    <section className="pb-10 relative bg-SecondaryColor-0 z-10 mt-5">
      <div className="Container">
        <div className="text-center">
          <h5 className="font-Rajdhani text-lg font-semibold text-PrimaryColor-0" style={{paddingTop:"40px"}}>
            Working Process
          </h5>
